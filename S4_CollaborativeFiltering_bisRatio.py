...
def main(topThr = 10, percent = 0.33, modified = 0,prt=0):
    ...
    filecsvEval = 'RESULT/CSV/Result_Algs_withES_diff_test.csv'#'Result_diff_test.csv'
    dataTest = Readata(filecsvEval)
    dataTest_drop = dataTest.drop('Video_ID', 1)
    
    filecsv = 'RESULT/CSV/Result_Algs_withES_diff_valid.csv'#'Result_diff_test.csv'
...
if __name__ == "__main__":
    ...
    runMain(modified=1, ratio = 0.2, top =10, prefix = 'RESULT/Proposed')
    runMain(modified=0, ratio = 0.2, top =10, prefix = 'RESULT/Original')
